<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($laboratorio, ['method' => 'PUT', 'route' => ['admin.laboratorios.update', $laboratorio->id]]); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('nummaquinas', 'Codigo Maquinas*', ['class' => 'control-label']); ?>
