            ...
            <table class="table  table-striped <?php echo e(count($materias)  > 0 ? '' : ''); ?> dt-select">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->getFromJson('global.materias.fields.descripcionmateria'); ?></th>
                        <!-- <th>Grupo</th> -->
                        <th>Portafolio</th>
                        <th>&nbsp;</th> 
                    </tr>
                    ...
                    <?php if(count($materias) > 0): ?>
                        <?php $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($materia->id); ?>">
                                ...
                                <?php if(App\GrupoMateria::all()->pluck('materia_id')->first() == $materia->id): ?> 
                                    <!-- <td><?php echo e($materia->idMateria); ?></td> -->
                                    <td><?php echo e($materia->nombremateria); ?></td>
                                    <td><?php echo e($materia->codigomateria); ?></td>
                                    <td><?php echo e($materia->descripcionmateria); ?></td>
                                    <!-- <td><?php echo e($materia->grupoMateria); ?></td> -->
                                    <td> <a href="<?php echo e(route('auxmaterias.edit',[$materia->id])); ?>" class="btn btn-xs btn-info">Portafolio</a></td>
                                <?php endif; ?>
                            </tr>
