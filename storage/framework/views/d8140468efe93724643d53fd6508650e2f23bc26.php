...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        <a href="<?php echo e(route('admin.auxasignaciones.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('global.app_add_new'); ?></a>
    </p>
                    ...
                    <?php if(count($asignaciones) > 0): ?>
                        ...
                        <?php if($asignacion->grupoMateria()->pluck('nombregrupomat')->first()==null): ?>
                            <tr data-entry-id="<?php echo e($asignacion->id); ?>">
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.auxasignaciones.edit',[$asignacion->id])); ?>" class="btn btn-xs btn-info"><?php echo app('translator')->getFromJson('global.app_edit'); ?></a>
