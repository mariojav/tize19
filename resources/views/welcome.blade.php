                         ...
                         <div class="entry-form">
                            ...
                            <input type="hidden"
                                 ...
                                 value="{{ csrf_token() }}">
                                   ...
                                   <input type="email" name="email" class="form-control" placeholder="Tu correo electronico" required="" value="{{ old('email') }}">
                                    
                                   <input type="password" name="password" class="form-control" placeholder="Tu contraseña" required="" name="password">>
                                   
                                   <a style="color:White;" href="{{ route('auth.password.reset') }}">Forgot your password?</a>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                    <!--<a href="#"></a>-->                                                                                  
                                                  <a target="_blank"  href=" {{ url('home/horario/' . $laboratorio->id) }}" ><font size=4>{{ $laboratorio->nombrelab }}</font></a>                                                  
                                             </div>
