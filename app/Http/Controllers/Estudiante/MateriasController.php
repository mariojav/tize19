...
class MateriasController extends Controller
{
    ...
    public function index()
    {
        ...
        $materias=DB::table('materias')->join('grupos_laboratorio','materias.id','=','grupos_laboratorio.materia_id')->join('asignaciones','grupos_laboratorio.id','=','asignaciones.grupolaboratorio_id')->where('user_id',$userAuth)->select('user_id','codigomateria','materias.id','nombremateria','nombregrupolab')->distinct()->get();
        ...
        return view('estudiante.materia.index', compact('materias'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('estudiante.materia.edit', compact('materia','materiaId','docenteId'));
    }
