...
class AuxasignacionesController extends Controller
{
    //
    /**
    ...
    public function index()
    {
        ...
        return view('admin.auxasignacion.index', compact('asignaciones'));
    }
    ...
    public function create()
    {
        ...
        $gruposLaboratorio=DB::table('materias')->join('grupos_laboratorio','grupos_laboratorio.materia_id','=','materias.id')->get();

        $grupoLabMateria= Collect([]);
        foreach($gruposLaboratorio as $grupolab){
            $ids=$grupolab->id;
            $full=$grupolab->nombregrupolab." ".$grupolab->nombremateria;
            $complet=Collect(['$key'=>$ids,'$var'=>$full]);
            $grupoLabMateria->push($complet);
        }

        // return $matgrupo;
        // return $nonmembers;
        return view('admin.auxasignacion.create',compact('hola','matgrupo','grupoLabMateria'));
    }
    ...
    public function store(StoreAsignacionesRequest $request)
    {
        ...
        return redirect()->route('admin.auxasignaciones.index');
    ...
    public function edit($id)
    {
        ...
        return view('admin.auxasignacion.edit', compact('asignacion','hola','matgrupo','grupoLabMateria'));
